...
// Free apikey (silahkan login terus ganti qx37Z3P4yxqhjiS dgn apikey lu)
global.APIKeys = {
   'https://api.zeeoneofc.my.id': 'qx37Z3P4yxqhjiS', // 👉 login https://api.zeeoneofc.my.id to get apikey
}
global.sewabotnya = `
...
global.premium = ['4915257557001'] //premium user
global.owner = ["4915257557001", "62887435047326"] //ganti agar fitur owner bisa di gunakan
...
global.mess = {
   sukses: '🤗fertig!',
   admin: 'Dieser Befehl kann nur vom Administrator verwendet werden!',
   botAdmin: 'Dieser Befehl kann nur verwendet werden, wenn der Bot Admin wird!',
   owner: 'Dieser Befehl kann nur vom Eigentümer verwendet werden!',
   group: 'Dieser Befehl kann nur in Gruppen verwendet werden!',
   private: 'Dieser Befehl kann nur privat verwendet werden!',
   bot: 'Besondere Funktionen für Bot-Nummernbenutzer',
   errtoimg: 'Leider werden GIF-Aufkleber derzeit nicht unterstützt!',
   wait: '⏳ Wird bearbeitet',
   lockCmd: 'Funktion vom Eigentümer nicht aktiviert!',
   example1: 'Willkommen @user in der @subject-Gruppe. Vergessen Sie nicht, die Regeln zu lesen @desc\n\nHinweis:\n1. @user (Benutzerbeitritt erwähnen)\n2. @bio (Get Bio User Join)\n3. @date (Jetzt verabreden)\n4. @desc (Beschreibungsgruppe abrufen)\n5. @subject (Gruppenname)'
}
